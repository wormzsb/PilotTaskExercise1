...
int m_SignOrderLeft[12];                            //左边三维图形类型
int m_SignOrder1[6];                                //三维图形序列
int m_SignOrder2[6];                                //三维图形序列
unsigned long *m_SignStartTime=NULL;                //三维图形记忆开始时间
unsigned long *m_SignSureTime=NULL;                 //三维图形记忆确认时间
char (*m_LMemName)[30];                             //存放左边三维图形名称的数组
char (*m_RMemName)[30];                             //存放右边三维图形名称的数组
short *m_NoSame=NULL;                               //存放两边三维图形相同性的数组
short *m_LMemAngle=NULL;                            //存放左边三维图形旋转角度的数组
short *m_RMemAngle=NULL;                            //存放右边三维图形旋转角度的数组
short *m_MemAngleDiff=NULL;                         //存放两边三维图形旋转角度差的数组
short *m_SureButtonNo=NULL;
