...
namespace t6_1
{
	...
	extern int m_SignOrderLeft[12];                            //左边三维图形类型
	extern int m_SignOrder1[6];                                //三维图形序列
	extern int m_SignOrder2[6];                                //三维图形序列
	extern unsigned long *m_SignStartTime;                //三维图形记忆开始时间
	extern unsigned long *m_SignSureTime;                 //三维图形记忆确认时间
	extern char(*m_LMemName)[30];                             //存放左边三维图形名称的数组
	extern char(*m_RMemName)[30];                             //存放右边三维图形名称的数组
	extern short *m_NoSame;                               //存放两边三维图形相同性的数组
	extern short *m_LMemAngle;                            //存放左边三维图形旋转角度的数组
	extern short *m_RMemAngle;                            //存放右边三维图形旋转角度的数组
	extern short *m_MemAngleDiff;                         //存放两边三维图形旋转角度差的数组
	extern short *m_SureButtonNo;
